...
class WebTest(WebTest):
    ...
    def test_user_can_edit_returned_items(self):
        """
        Test that user can edit items
        """
        ...
        url = reverse('edit_returned_item', args=(), kwargs={'id': 1})
        ...
        form =  resp.forms['edit-returned-item']
