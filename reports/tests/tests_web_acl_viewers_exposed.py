...
class WebTest(WebTest):
    ...
    def test_user_masks(self):
        ...
        self.assertEqual(1, len(page.findAll(id='report-parts')))
        self.assertEqual(1, len(page.findAll(id='report-unapproved-rmas')))
        self.assertEqual(1, len(page.findAll(id='report-return-inventory')))
        self.assertEqual(1, len(page.findAll(id='report-customer-rma')))
        self.assertEqual(1, len(page.findAll(id='report-customer-sites')))
