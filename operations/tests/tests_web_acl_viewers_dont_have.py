...
class WebTest(WebTest):
    ...
    def test_user_masks(self):
        ...
        self.assertEqual(0, len(page.findAll(id='admin-edit-rma-extra-fields-nav')))
        self.assertEqual(0, len(page.findAll(id='admin-edit-commissioned-sites-extra-fields-nav')))
        self.assertEqual(0, len(page.findAll(id='django-admin-nav')))
        self.assertEqual(0, len(page.findAll(id='move-parts-app-nav-button')))
