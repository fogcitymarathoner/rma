...
class WebTest(WebTest):
    ...
    def test_viewer_cant_edit_customer(self):
        """
        Test that viewer can't edit customer
        """
    ...
    def test_view_cant_edit_customer_site(self):
        """
        Test that viewer cant edit customer site
        """
        c0_url = reverse('home_page')
